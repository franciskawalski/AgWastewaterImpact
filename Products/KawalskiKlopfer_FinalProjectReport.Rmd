...
source("../Code/Maps.R", local = knitr::knit_global())
stateNitrMap
```
...
This map depicts the average concentration levels of nitrogen in water sampled in each state from 2008-2012. Data in these years was not available for North Dakota and Wyoming.
